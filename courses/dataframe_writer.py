...
if __name__ == "__main__":
    ...
    partitioned_df.write.format("avro").mode("overwrite").option("path", "data_sink/avro/").save()
    (
        partitioned_df.write.format("json").mode("overwrite").option("path", "data_sink/json/")
